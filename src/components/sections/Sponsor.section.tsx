        ...
        <section className="sponsor-section relative z-[2]">
            ...
            <img src={MiddleBody} alt="Middle Body" className="w-full object-cover h-auto h-[1200px] sm:h-[1400px] md:h-[1300px] lg:h-[1200px]" style={{ zIndex: '1' }} />
                <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center space-y-6 sm:space-y-12" style={{ paddingTop: '200px' }}>
                    ...
                    <div className="flex justify-center items-center sm:space-x-16 space-x-4" style={{ paddingLeft: '1rem', paddingRight: '1rem' }}>
                    ...
                    <div className="flex justify-center items-center space-x-6" style={{ paddingLeft: '1rem', paddingRight: '1rem' }}>
                        <div className="h-12 sm:h-15 flex justify-center items-center"> 
                    ...
                    <div className="flex justify-center items-center"  style={{ paddingLeft: '2rem', paddingRight: '2rem' }}>
