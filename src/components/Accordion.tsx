        ...
        <div className="py-20 grid md:grid-cols-2 gap-5">
            {items.map((item, index) => (
                <div key={index} className="w-full">
                    <div
                        className={`cursor-pointer flex justify-between items-center p-4 bg-white hover:bg-accordionHover border-black rounded-xl border select-none ${activeIndex === index ? 'rounded-b-none' : ''}`}
