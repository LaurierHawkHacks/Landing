        ...
        <div className="col-md-9 col-lg-8 col-xl-7 mx-auto">
            ...
            <Accordion>
                <Stack gap={3}>
                    ...
                    >
                        No worries! 
                        Reach out to us at <strong>hello@hawkhacks.com</strong> or our social media, and we’ll get back to you as soon as our social media and email person wakes up!
                    </FAQEntry>
                </Stack>
            </Accordion>
        </div>
